...
metadata
{
	definition(name: "HubConnect Iris IL071 Motion Sensor", namespace: "shackrat", author: "Steve White", ocfDeviceType: "oic.r.sensor.motion")
	{
	...
	tiles(scale: 2)
	{
		...
		main "motion"
		details(["motion", "sync", "temperature", "humidity", "battery", "refresh", "version"])
	}
}
